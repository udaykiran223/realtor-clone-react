        ...
        <div className=" flex space-x-6 mb-6 ">
          <div className="">
            ...
            <input
              ...
              max="50"
              required
              className="w-full px-4 py-2 text-xl rounded text-gray-700 bg-white border border-gray-300 transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center "
            />
          </div>
          <div className="">
